...
const Contact = () => {
  ...
  return (<>
    <section id="contact" className="bg-gray-100 text-center p-4 md:px-0 h-auto ">
      ...
      {/* WhatsApp Link */}
      <p className="mt-8">Prefer WhatsApp? <a href="https://api.whatsapp.com/send?phone=7021235201&text=Hello%2C%20I%20have%20a%20question%20about%20your%20services" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Chat with us on WhatsApp</a>.</p>
    </section>
  </>
  );
};
